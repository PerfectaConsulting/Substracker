profile "BusinessRole Center"
{
    Caption = 'BusinessRole Center';
    Description = 'Role Center for MIS Demo Company and Simplr-MIS Test';
    RoleCenter = "BusinessRole Center"; // Must match the Role Center page name exactly
    //Default = false; // This prevents it from being the system-wide default role
    //Customizable = true; // Allows users to modify their UI layout
}

page 70122 "BusinessRole Center"
{
...
#pragma warning restore AS0072
        ...
        area(sections)
        {
            ...
            group(SubsTracker)
            {
                action("SubsTrackerButton")
                {
                    Caption = 'Dashboard';
                    ApplicationArea = All;
                    RunObject = Page "SubsTracker Dashboard";
